...
public class SpringWebConfig implements WebMvcConfigurer, ApplicationContextAware {
    ...
    public void addFormatters(final FormatterRegistry registry) {
        ...
        registry.addFormatter(varietyFormatter(applicationContext.getBean(VarietyService.class)));
        registry.addFormatter(dateFormatter(applicationContext.getBean(MessageSource.class)));
    }

    @Bean
    public VarietyFormatter varietyFormatter(VarietyService varietyService) {
        return new VarietyFormatter(varietyService);
    }

    @Bean
    public DateFormatter dateFormatter(MessageSource messageSource) {
